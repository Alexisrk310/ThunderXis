        ...
        <body style="${css.body}">
          <div style="${css.container}">
            ...
            <div style="${css.footer}">
              ...
              <p style="color: #27272a; font-size: 12px; margin: 0;">© ${new Date().getFullYear()} ThunderXis. Be Brave.</p>
            </div>
          </div>
        </body>
        </html>
      ...
      html: `
        ...
        <body style="${css.body}">
          <div style="${css.container}">
            ...
            <div style="${css.footer}">
               <p style="color: #52525b; font-size: 12px;">© ${new Date().getFullYear()} ThunderXis. All rights reserved.</p>
            </div>
          </div>
        </body>
        </html>
